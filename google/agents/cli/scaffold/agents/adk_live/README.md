...
- **Python Backend** (in `app/` folder): ADK-powered agent using Gemini's live audio model with native tool calling and deployment support for Cloud Run and Agent Runtime
...
- [Gemini API Cookbook](https://github.com/google-gemini/cookbook): Practical examples and tutorials for working with the Gemini API
