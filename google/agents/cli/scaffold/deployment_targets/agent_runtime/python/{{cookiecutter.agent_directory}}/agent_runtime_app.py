...
class AgentEngineApp(A2aAgent):
    """Agent Runtime App with A2A Protocol support for LangGraph agents."""
    ...
    def create() -> "AgentEngineApp":
        ...
        """
        # Handle nested asyncio contexts (like notebooks or Agent Runtime)
        try:
            asyncio.get_running_loop()
            nest_asyncio.apply()
        except RuntimeError:
    ...
    async def build_agent_card() -> AgentCard:
        ...
        agent_card = AgentCard(
            ...
            url="http://localhost:9999/",  # RPC URL for Agent Runtime
